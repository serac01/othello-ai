 ...
 */
public class AlphaBetaOrderingMoves implements OthelloAlgorithm {
	protected int searchDepth;
	protected boolean isWhitePlaying;
	protected static final int DefaultDepth = 7;
	protected OthelloEvaluator evaluator;

	public AlphaBetaOrderingMoves() {
		this.evaluator = new CountingEvaluator();
		this.searchDepth = DefaultDepth;
	}

	public AlphaBetaOrderingMoves(OthelloEvaluator eval) {
		this.evaluator = eval;
		this.searchDepth = DefaultDepth;
	}

	public AlphaBetaOrderingMoves(OthelloEvaluator eval, boolean isWhitePlaying) {
		this.evaluator = eval;
		this.isWhitePlaying = isWhitePlaying;
		this.searchDepth = DefaultDepth;
	}

	public AlphaBetaOrderingMoves(OthelloEvaluator eval, int depth) {
		this.evaluator = eval;
